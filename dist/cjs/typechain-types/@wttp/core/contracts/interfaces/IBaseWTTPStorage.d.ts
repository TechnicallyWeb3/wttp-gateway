...
export interface IBaseWTTPStorageInterface extends Interface {
    getFunction(nameOrSignature: "DPR" | "DPS" | "changeSiteAdmin" | "createResourceRole" | "getRoleAdmin" | "getSiteAdminRole" | "grantRole" | "hasRole" | "renounceRole" | "revokeRole"): FunctionFragment;
...
export interface IBaseWTTPStorage extends BaseContract {
    connect(runner?: ContractRunner | null): IBaseWTTPStorage;
    waitForDeployment(): Promise<this>;
    interface: IBaseWTTPStorageInterface;
...
//# sourceMappingURL=IBaseWTTPStorage.d.ts.map