...
export interface IBaseWTTPPermissionsInterface extends Interface {
    getFunction(nameOrSignature: "changeSiteAdmin" | "createResourceRole" | "getRoleAdmin" | "getSiteAdminRole" | "grantRole" | "hasRole" | "renounceRole" | "revokeRole"): FunctionFragment;
...
export interface IBaseWTTPPermissions extends BaseContract {
    connect(runner?: ContractRunner | null): IBaseWTTPPermissions;
    waitForDeployment(): Promise<this>;
    interface: IBaseWTTPPermissionsInterface;
...
//# sourceMappingURL=IBaseWTTPPermissions.d.ts.map