...
(0, config_1.task)("gateway:fetch", "Fetch a resource from a WTTP site via the WTTPGateway")
    ...
    const gateway = await hre.ethers.getContractAt("WTTPGateway", wttp);
    ...
    // Fetch the resource
    const response = await fetchResource(gateway, site, path, {
        range: rangeOption,
