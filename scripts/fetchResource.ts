...
import { HEADResponseStructOutput } from "../typechain-types/contracts/IWTTPSite";
import { GETResponseStructOutput } from "../typechain-types/contracts/WTTPGateway.sol/WTTPGateway";
