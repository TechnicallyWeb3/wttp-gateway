...
import "@tw3/wttp-core/contracts/interfaces/IWTTPSite.sol";
...
contract WTTPGateway {
    ...
    function OPTIONS(
        ...
        return IWTTPSite(_site).OPTIONS(_optionsRequest);
    }
    ...
    function GET(
        ...
        LOCATEResponse memory locateResponse = IWTTPSite(_site).GET(_getRequest.head);
    ...
    function HEAD(
        ...
        return IWTTPSite(_site).HEAD(_headRequest);
    }
